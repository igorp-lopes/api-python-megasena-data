...
from src.app.adapters.sqlmodel.repositories.mega_sena_data_repository import MegaSenaDataRepository
...
class Container(containers.DeclarativeContainer):
    ...
    mega_sena_data_repository = providers.Factory(MegaSenaDataRepository, engine=db_engine)
